...
[System Tray Menu](https://developer.github.com/pirST/explore/systray).
...
See [full API](https://pkg.go.dev/github.com/pirST/systray?tab=doc) as well as [CHANGELOG](https://github.com/fyne-io/systray/tree/master/CHANGELOG.md).
